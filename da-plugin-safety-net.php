...
/**
 * Displays a warning modal when a user clicks the deactivate or activate link for a plugin.
 *
 * @return void
 */

function da_plugin_actions_speedbump()
{
    global $pagenow;
...
add_action('admin_footer', 'da_plugin_actions_speedbump');
...
function da_plugin_action_log()
{
    ...
    check_ajax_referer('plugin_action_log_nonce', 'security');
